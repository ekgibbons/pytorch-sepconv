...
from  _support import GenerateHeartData
from  _support import DataLoader
from  _support import model
from  _support import VggLoss
        ...
        for phase in ["train", "val"]:
            ...
            if phase == "val" and epochLoss < bestLoss:
                print("val Loss decreased from: {:0.4g} to {:0.4g}...saving model".format(bestLoss,
                                                                                          epochLoss))
                bestLoss = epochLoss
                torch.save(model.state_dict(),"/v/raid1a/egibbons/models/network-ft.pytorch")
...
def main():
    ...
    moduleNetwork.load_state_dict(torch.load('/v/raid1a/egibbons/models/network-lf.pytorch'))
