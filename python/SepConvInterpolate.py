...
modulePath = os.path.realpath(os.path.abspath(os.path.split(inspect.getfile(inspect.currentframe()))[0]))
...
def SepConv(im1,im2,modelType="ft"):
    ...
    moduleNetwork.load_state_dict(torch.load("/v/raid1a/egibbons/models/network-%s.pytorch" 
                                             % modelType))
